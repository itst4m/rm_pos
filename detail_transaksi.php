	...
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				...
				if ($_SESSION['status']==1) {
				?>
				<h3 class="jdl">Detail Laporan Pembelian Rumah Makan HI-TAM</h3>
				<?php }else{ ?>
				<h3 class="jdl">Detail Transaksi Pembelian Rumah Makan HI-TAM</h3>
				<?php } ?>
				<?php
				...
				$data=$root->con->query("select makanan.nama_barang,makanan.harga_jual,sub_transaksi.jumlah_beli,sub_transaksi.total_harga from sub_transaksi inner join makanan on makanan.id_barang=sub_transaksi.id_barang where sub_transaksi.id_transaksi='$_GET[id_transaksi]'");
